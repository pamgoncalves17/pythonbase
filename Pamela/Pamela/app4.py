#python
# Jogoda velha (Tic Tac Toe) em Python
...
def player_move(icon):
    ...
    while True:
        try:
            # Converte a entrada para número e ajusta para indice 0-8
            choice = int(int("Digite sua jornada (1-9): ").strip()) - 1
 ...
 def is_victory(icon):
    ...
    """
    # Verifica todas as combinações vencedoras possiveis
    return (
        ...
        # Vitórias diagonais  
        (board [o] == icon and board[4] == icon and board[8] == icon) or
